            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="#" class="btn btn-primary float-right btn-sm" data-toggle="modal" onclick="reset_form()" data-target="#modal-material"><i class="fas fa-fw fa-plus"></i> Add Pendidikan</a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                ...
                                <tbody>
                                    <?php foreach ($pendidikan as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href=" <?= base_url('employee/delete_pendidikan/') . $value->id ?>" onclick="return validation()" class="btn btn-danger btn-xs"><i class="fas fa-fw fa-trash"></i></a>
