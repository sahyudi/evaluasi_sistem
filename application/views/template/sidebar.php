        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <a class="nav-link" href="<?= base_url('information') ?>">
                            ...
                            <?php foreach ($menu_load as $k => $m) { ?>
                                ...
                                <?php if (check_persmission_views($this->session->userdata('group_id'), $m->id)) { ?>
                                    <?php if ($m->link == '#' || $m->link == '') {  ?>
                                        ...
                                        <a class="nav-link <?= ($m->link == $active) ? 'active' : ' ' ?>" href="#" data-toggle="collapse" data-target="#<?= $value->name . '-' . $k ?>" aria-expanded="false" aria-controls="<?= $value->name . '-' . $k ?>">
                                            <div class="sb-nav-link-icon"><i class="fas <?= $m->icon ?>"></i></div>
                                            <?= $m->title ?>
                                            <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                                        </a>
                                        <div class="collapse" id="<?= $value->name . '-' . $k ?>" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
