...
<head>
    ...
    <link href="<?= base_url() ?>dist/css/dataTables.bootstrap4.min.css" rel="stylesheet" crossorigin="anonymous" />
...
<body class="sb-nav-fixed">
    ...
    <script src="<?= base_url() ?>dist/js/Chart.min.js" crossorigin="anonymous"></script>
    ...
    <script src="<?= base_url() ?>dist/js/jquery.dataTables.min.js" crossorigin="anonymous"></script>
    <script src="<?= base_url() ?>dist/js/dataTables.bootstrap4.min.js" crossorigin="anonymous"></script>
